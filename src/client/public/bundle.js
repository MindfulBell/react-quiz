...
/***/ function(module, exports, __webpack_require__) {
	...
	var _question = __webpack_require__(/*! ./question */ 159);
	
	var _question2 = _interopRequireDefault(_question);
	
	var _choice = __webpack_require__(/*! ./choice */ 160);
	
	var _choice2 = _interopRequireDefault(_choice);
	
	var _choice_list = __webpack_require__(/*! ./choice_list */ 161);
	
	var _choice_list2 = _interopRequireDefault(_choice_list);
	
	var _reactAddonsCssTransitionGroup = __webpack_require__(/*! react-addons-css-transition-group */ 162);
	...
	var GameHolder = function (_React$Component) {
	  _inherits(GameHolder, _React$Component);
	
	  function GameHolder(props) {
	    _classCallCheck(this, GameHolder);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(GameHolder).call(this, props));
	  ...
	  _createClass(GameHolder, [{
	    key: 'processAnswer',
	    value: function processAnswer(userChoice) {
	    ...
	    value: function render() {
	      ...
	      var endGameDiv = this.state.usedItems.length === 8 ? _react2.default.createElement(
	        'div',
	        { className: 'endGame' },
	        'Thanks for playing! Your score is ',
	        this.state.score,
	        '!'
	      ) : null;
	      var QandA = this.state.QandA; //getting QandA from state, good.
	      var processAnswer = function processAnswer(userChoice, QandA) {
	        _this2.processAnswer(userChoice);
	      };
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'holder container-fluid' },
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_question2.default, { modNum: QandA, QuesMods: QsAndAs }),
	          _react2.default.createElement(_choice_list2.default, { modNum: QandA, QuesMods: QsAndAs, onUserClick: processAnswer })
	        )
	      );
	    }
	  }]);
	...
	(0, _reactDom.render)(_react2.default.createElement(GameHolder, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Choice = function Choice(props) {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'div',
	      { className: 'choice', onClick: function onClick(event) {
	          return userSelection(event.target.innerHTML);
	        } },
	      props.choiceText
	    )
	  );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChoiceList = function ChoiceList(_ref) {
	  var QuesMods = _ref.QuesMods;
	  var modNum = _ref.modNum;
	  ...
	  var choicesList = nums.map(function (number, ind) {
	    return _react2.default.createElement(_choice2.default, { key: ind, choiceText: QuesMods[modNum][choiceArray[number]], onUserClick: onUserClick });
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! react/lib/ReactCSSTransitionGroup */ 163);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactTransitionGroup = __webpack_require__(/*! ./ReactTransitionGroup */ 164);
	var ReactCSSTransitionGroupChild = __webpack_require__(/*! ./ReactCSSTransitionGroupChild */ 166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(/*! ./React */ 2);
	var ReactTransitionChildMapping = __webpack_require__(/*! ./ReactTransitionChildMapping */ 165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CSSCore = __webpack_require__(/*! fbjs/lib/CSSCore */ 167);
	var ReactTransitionEvents = __webpack_require__(/*! ./ReactTransitionEvents */ 168);
